<?php
  ...
  $q_get_report="SELECT rtd_id, rth_code, tth_code, rth_date, itemd_code, masti_name, itemd_capacity, uom_name, 
  ...
  if (mysqli_num_rows($exec_get_report)>0)
     {
	   ...
	   $rows_data="No Transaksi"."\t"."No Referensi"."\t"."Tanggal"."\t"."Kode Aset"."\t"."Deskripsi Isi Aset"."\t"."Serial"."\t"."Kapasitas"."\t"."Kategori"."\t"."Qty"."\t"."Kantor Cabang Asal"."\t"."Lokasi Gudang"."\t"."Dibatalkan"."\t"."Keterangan"."\n"; 
	   while ($field_data=mysqli_fetch_array($exec_get_report))
			 {
			   ...
			   $rows_data=$rows_data.$field_data['rth_code']."\t".$field_data['tth_code']."\t".$field_data['rth_date']."\t".$field_data['itemd_code']."\t".$field_data['masti_name']."\t".$field_data['itemd_serial_no']."\t".$field_data['itemd_capacity']." ".$field_data['uom_name']."\t".$field_data['cati_name']."\t".$field_data['itemd_qty']." Cylinder"."\t".$field_data['branch_name_from']."\t".$field_data['whsl_id_new']."\t".$is_canceled."\t".$field_data['rtd_notes']."\n";
			 }
