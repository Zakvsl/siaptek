...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" name="f_pic_customer" id="f_pic_customer">
  <table width="892" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <th colspan="6" scope="col">&nbsp;</th>
    </tr>
    <tr>
      <th colspan="6" scope="col"><div align="left">NAMA PIC CUSTOMER</th>
    </tr>
    <tr>
      <td width="18%">Kode Customer </td>
      <td width="1%">:</td>
    ...
    <tr>
      <td><label>
        <input type="button" id="btn_add" name="btn_add" value="+" onClick="input_data()">
		<input type="button" id="btn_update" name="btn_update" value="+/-" onClick="update_data()">
		<input type="button" id="btn_delete" name="btn_delete" value="-" onClick="delete_data()">
      </label></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
	...
	function input_data()
	         {
			   ...
			   var cid='<?php echo $id;?>';
			   open_child=window.open("../../data/customer/cru_pic_customer.php?c=i&cid="+cid, "f_cru_pic_customer", "location=no,resizable=no, height="+h+", width="+w+", left="+l+", top="+t+", toolbar=0");
			 }	
	...
	function update_data()
	         {
			   ...
			   if (z>1)
			      ...
			      {
				    open_child=window.open('../../data/customer/cru_pic_customer.php?c=u&id='+value_id+'&cid='+cid, 'f_cru_pic_customer', 'height='+h+', width='+w+', left='+l+', top='+t+', toolbar=0');
				  }
			 }  
  ...
  function delete_data()
           {
			 ...
			 if (z==0)
		     ...
		     else
			    {
				  ...
				  if (answer)
				     {
					   document.f_pic_customer.action="../../data/customer/delete_pic_customer.php?cid="+a;
					   document.f_pic_customer.submit();
					 }  
				}
		   }   
</script>
