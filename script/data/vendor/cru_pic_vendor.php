...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" name="f_cru_pic_vendor" id="f_cru_vendor">
  <table width="403" border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <th colspan="3" scope="col"><div align="left"><?php if ($cru=='i') 
	                                                         {
															   echo "TAMBAH DATA PIC VENDOR";
															 }
														  else
														  if ($cru=='u')
														     {
															   echo "UBAH DATA PIC VENDOR";
															 }
													?>	  </th>
    </tr>
